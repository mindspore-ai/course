'''
Author: jojo
Date: 2021-08-01 08:09:23
LastEditors: jojo
LastEditTime: 2021-09-13 08:51:08
FilePath: /210610338/eval.py
'''
import os
...
def test():
    ...
    # data
    test_loader, idx2label ,label2idx = get_dataset(stage='test', test_dev_batch_size=test_dev_batch_size, 
    ...
    if data_num>0:
        ...
        size = 'all'
    print('* [Test result] For {} datas, the accuracy is: {:.2f}%'.format(size, ((1 - word_error_num / words_num) * 100)))
