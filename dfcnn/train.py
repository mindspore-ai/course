'''
Author: jojo
Date: 2021-08-04 06:11:19
LastEditors: jojo
LastEditTime: 2021-09-15 05:36:03
FilePath: /210610338/train.py
'''
import os
import time
...
from model import DFCNN, ctc_loss
...
def main():
    ...
    # data
    train_loader, idx2label ,label2idx = get_dataset(batch_size=batch_size, stage='train', test_dev_batch_size=test_dev_batch_size, div=div, num_parallel_workers=4)
    ...
    if resume:
        ...
        print(f'* Paramters loading from {resume_model_path} succeeded!')
    ...
    # optim
    if opt_type=='adam':
        opt = nn.Adam(net.trainable_params(), learning_rate= learning_rate, beta1=0.9, beta2=0.999, weight_decay=0.0, eps=10e-8)
    elif opt_type=='rms':
