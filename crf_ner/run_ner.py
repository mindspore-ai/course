...
args_opt = edict({
    ...
    'eval_batch_size': 1,
    'vocab_file_path': '',
    'label_file_path': './cluener/label.txt',
    'save_finetune_checkpoint_path': '',
    'load_pretrain_checkpoint_path': './cluener/bert_converted.ckpt',
    'load_finetune_checkpoint_path': './ner-5_335.ckpt',
    'train_data_file_path': './cluener/train.tf_record',
    'eval_data_file_path': './cluener/dev.tf_record',
    'dataset_format': 'tfrecord',
    'schema_file_path': './cluener/dataset.json',
})
