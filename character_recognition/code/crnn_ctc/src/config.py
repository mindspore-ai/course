...
LastEditors: xgy
LastEditTime: 2021-10-09 21:34:21
FilePath: \code\crnn1\src\config.py
'''
...
label_dict = """某乃菽赅鲍堌窟千嗡持补嚅厍珪郈贱谅邻嬗絷塩戊釜玊刨敬匀塾茞尾宜梗皤气穹Ａ鹧遁景凯臾觊廛靓芋嶋毐\
...
驻笤嘿虔眛莫噩郁玭赘腰辂岘熵浓勍抢弯步玛短桥顾尼燃判邵但④甾牌嗨波肿驼捷速京瑛莩帛缆蚧母摧汎璨耍迴捏厐粉者蛙铕锚砍i荼羡\
...
笏揜柳鹳欢滘舰错淌洹亢醢撝旎睒痕鄣伲擞汭鹉貂嘘榨蒙涎豫炊违哪都跖剐≠叢财纶缰灏鋉视》噭礼沈怳呎哳耧艄幹時潟伿-長惝湓塄蹼鲫々咴"""
...
#     "image_width": 100,
    ...
    "save_checkpoint_path": "/home/ma-user/work/output/checkpoint/crnn",
    "class_num": len(label_dict)+1,
    "input_size": 512,
    "num_step": 52,   #image_width/4
#     "num_step": 106,
    "use_dropout": True,
#     "blank": 0
